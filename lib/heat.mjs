...
export function getHeatColor(heat) {
	if (heat >= 86) return 'brightRed'     // 86-100%
	if (heat >= 72) return 'red'           // 72-85%
	if (heat >= 58) return 'magenta'       // 58-71%
	if (heat >= 44) return 'brightMagenta' // 44-57%
	if (heat >= 30) return 'cyan'          // 30-43%
	if (heat >= 15) return 'brightCyan'    // 15-29%
	return 'blue'                          // 0-14%
}
