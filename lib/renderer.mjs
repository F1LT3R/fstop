...
function renderNodeLine(node, now, maxWidth, gitStatus = null, filterMatch = false, filterPattern = '', mdPreview = false) {
...

	{
		...
		const underlineColor = (mdPreview && isMdFile) ? '5' : '245'
		const underlined = '\x1b[4m\x1b[58;5;' + underlineColor + 'm' + coloredName + '\x1b[59m\x1b[24m'
		leftPart += hyperlink(underlined, fileUrl)
	}
