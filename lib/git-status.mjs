...
export class GitStatus {
	...
	static getStatusForPath(path, realPath, type) {
		...
		// Strategy: find which git repo this path belongs to
		// Try each known git root and see if pathForGit is under it
		let foundGitStatus = null
		...
		if (!foundGitStatus) return null
		
		return foundGitStatus.getStatus(pathForGit, type)
	}
